...
describe("node", function() {
	...
	describe("#getAllChildrenSuccessors()", function() {
		var o1 = new Component.variable("number");
		var o2 = new Component.variable("number");
		var o3 = new Component.variable("number");
		var n1 = new Component.node(Component.NODE_TYPE_CONDITION);
		...
		n5.attachInputOperand(o3, 0);
		n4.attachNode(n5, 0);
		var res = n4.getAllChildrenSuccessors();
		it("There should be 2 successors from n4", function() {
			Assert(res.length == 2);
		});
		it("n4, n5 should be the children successors of n4", function() {
			Assert(res.indexOf(n4) != -1 && res.indexOf(n5) != -1);
		});
	});

	describe("#getAllChildrenSolutionSuccessors()", function() {
		var o1 = new Component.variable("number");
		var o2 = new Component.variable("number");
		var o3 = new Component.variable("number");
		var n1 = new Component.node(Component.NODE_TYPE_CONDITION);
		...
		n5.attachInputOperand(o3, 0);
		n4.attachNode(n5, 0);
		var res = n4.getAllChildrenSolutionSuccessors();
